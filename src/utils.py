...
def second_column():
            ...
            st.write(" ")
            st.markdown("<span style='color:#5A5A5A;'>👉🏽 RAG_Chatbot is ready ✌. You can ask your question. Also, explore summary tab to generate document summary, extract talking points and look at sample questions.",unsafe_allow_html=True)
...
def contact():
    ...
    st.markdown("""LinkedIn :[Aswin Karthik Panneer Selvam](https://www.linkedin.com/in/anand-mandilwar/)
